...
$count=0;
if($pagenumber>1){
  echo '<li><a href="event.php?page=' . ($pagenumber-1) . '&search=' . $id . '">Previous</a></li>';
  echo '<li><a href="event.php?page=' . 1 . '&search=' . $id . '">' . 1 . '</a></li>';
  echo '<li><a >' . "..." . '</a></li>';
}
for ($page; $page <= $number_of_pages; $page++) {
  ...
  if($pagenumber==$page){
  echo '<li><a style="background-color:#0D7EFF;color:white;" href="event.php?page=' . $page . '&search=' . $id . '">' . $page . '</a></li>';
}else{
  echo '<li><a disabled href="event.php?page=' . $page . '&search=' . $id . '">' . $page . '</a></li>';
}
  $count++;
}
if($pagenumber<($number_of_pages-3)){
  echo '<li><a class="disabled" style=" cursor: not-allowed;opacity: 0.5;">' . "..." . '</a></li>';
  echo '<li><a href="event.php?page=' . $number_of_pages . '&search=' . $id . '">' . $number_of_pages . '</a></li>';
  }
  if($pagenumber<$number_of_pages){
    echo '<li><a href="event.php?page=' . ($pagenumber+1) . '&search=' . $id . '">Next</a></li>';
  }
echo '</ul>
  </div>
</div>
