...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
     ...
     <td class="fc-event-container" rowspan="2"><a class="fc-day-grid-event fc-h-event fc-event fc-start fc-end important fc-draggable"><div class="fc-content"><span class="fc-time">12a</span> <span class="fc-title">dawdwa</span></div></a></td>
