...
<form class="form-signin" style="margin-left: 30%;margin-right: 30%;margin-top: 4%;" action="php/login.php" method="post">
    ...
    <img class="mb-4" src="img/dgnm.png" width="280" height="82" style="margin-top: -25px;">
        ...
        <p style="margin-top: -25px;">Please provide proper Username and Password</p>
    </div>
